...
################################ Original Fare ################################
  ...
  dimension: original                       { type: string group_label: "5.Original Fare" sql: ${TABLE}.original ;;}
...
################################ Next Fare ################################
  ...
  dimension: next                     { type: string group_label: "8.Next Fare" sql: ${TABLE}.next ;;}
...
################################ Promoted ################################
  ...
  dimension: best_promoted                { type: string group_label: "9.Promoted" sql: ${TABLE}.best_promoted ;;}
